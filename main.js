 ...
 *  {
 *      "common": {
 *          "name":         "hilink",                  // name has to be set and has to be equal to adapters folder name and main file name excluding extension
 *          "version":      "0.0.0",                    // use "Semantic Versioning"! see http://semver.org/
 *          "title":        "Node.js hilink Adapter",  // Adapter title shown in User Interfaces
 *          "authors":  [                               // Array of authord
 *              "name <mail@hilink.com>"
 *          ]
 *          "desc":         "hilink adapter",          // Adapter description shown in User Interfaces. Can be a language object {de:"...",ru:"..."} or a string
...
// adapter will be restarted automatically every time as the configuration changed, e.g system.adapter.hilink.0
...
function main() {
     ...
     *
     *      Here a simple hilink for a boolean variable named "testVariable"
     *
...
*/
    ...
    // in this hilink all states changes inside the adapters namespace are subscribed
